...
class AutoMixParserTest {
    ...
    class AutoMixParserParseFunctionTest(
        ...
        companion object {
            ...
            fun getTestingData() = listOf(
                arrayOf("${AUTOMIX_FOLDER}/rss_v2_itunes_google_full.xml", FULL_AUTOMIX_CHANNEL),
                arrayOf("${AUTOMIX_FOLDER}/rss_v2_itunes_google_without_items.xml", PARTIAL_AUTOMIX_CHANNEL),
                arrayOf("${AUTOMIX_FOLDER}/rss_v2_itunes_google_without_itunes_attrs.xml", PARTIAL_AUTOMIX_CHANNEL_2),
                )
        }
    ...
    @RunWith(Parameterized::class)
    class AutoMixErrorTagParserErrorTagTest(private val rssFilePath: String): ErrorTagParserBaseTest() {
